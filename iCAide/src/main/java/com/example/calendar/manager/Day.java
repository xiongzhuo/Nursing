...
import com.example.calendar.utils.ChinaDate;

public class Day {

	private static final DateTimeFormatter mFormatter = DateTimeFormat
			.forPattern("d");
	...
	private int mTaskNum = -1;// -1或0表示不显示，大于0则显示
	...
	private int unDoNum = 0;// -1或0表示不显示，大于0则显示

	public int getTaskNum() {
		return mTaskNum;
	}

	public void setTaskNum(int mTaskNum) {
		this.mTaskNum = mTaskNum;
	}
	...
	public boolean equals(Object o) {
		...
		if (mEnabled != day.mEnabled)
			return false;
		if (mSelected != day.mSelected)
			return false;
		if (mToday != day.mToday)
			return false;
		if (!mDate.isEqual(day.mDate))
			return false;
	...
	public String getChinaDate() {
		long[] l = ChinaDate.calElement(mDate.getYear(),
				mDate.getMonthOfYear(), mDate.getDayOfMonth());
