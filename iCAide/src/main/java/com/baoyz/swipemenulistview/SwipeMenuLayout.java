...
public class SwipeMenuLayout extends FrameLayout {
	...
	public boolean onSwipe(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			if (isFling || (mDownX - event.getX()) > (mMenuView.getWidth() / 2)) {
				...
				if(null!=onMenuMoveChange){
					onMenuMoveChange.open();
				}
				}
			} else {
				// close
	...
	public void setMenuView(SwipeMenuView mMenuView) {
	...
	private  OnMenuMoveChange onMenuMoveChange; 
	public void setOnMenuMoveChange(OnMenuMoveChange onMenuMoveChange){
			this.onMenuMoveChange=onMenuMoveChange;
	}
	/**
	 * 滑动后，打开或关闭菜单接口
	* @author  yung
	* @date 创建时间：2016年1月4日 上午11:15:56 
	* @version 1.0
	 */
	public interface OnMenuMoveChange{
		public void open();
		public void close();
	}
}
