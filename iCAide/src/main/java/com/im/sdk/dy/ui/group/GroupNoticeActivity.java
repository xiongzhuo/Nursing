...
public class GroupNoticeActivity extends ECSuperActivity implements
    ...
    protected int getLayoutId() {
        return R.layout.im_group_notice_activity;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, R.drawable.btn_back_style, getString(R.string.app_clear), getString(R.string.app_title_notice), this);
    }
    ...
    public class GroupNoticeAdapter extends CCPListAdapter<DemoGroupNotice> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null || convertView.getTag() == null) {
                view = View.inflate(mContext, R.layout.im_group_notice_list_item, null);
