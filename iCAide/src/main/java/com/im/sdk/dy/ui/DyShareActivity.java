...
public class DyShareActivity extends ECSuperActivity {
	...
	private final AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent=new Intent(mcontext, DepartContactsActivity.class);
	...
	protected void onDestroy() {
		tools.putValue(Constants.IM_IS_SHARE,0);
		tools.putValue(Constants.SHARE_CONTENT,"");
		super.onDestroy();
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tools.putValue(Constants.IM_IS_SHARE,1);
		layoutInflate=LayoutInflater.from(mcontext);
		setContentView(R.layout.im_contacts_department_fragment);
		topView= (CommonTopView) this.findViewById(R.id.topView);
		topView.init(this);
		topView.setTitle("通讯录");
	...
	private void initContactListView() {
		...
		String str=SharedPreferencesUtil.getString(mcontext, "hospitalFriendList", "");
		list.clear();
		...
		if (mType == TYPE_NORMAL) {
			// mSelectCardItem = View.inflate(mcontext,
			// R.layout.im_contacts_add_bar, null);
			mSelectCardItem = View.inflate(mcontext, R.layout.new_friend,
					null);

			TextView text2=(TextView) mSelectCardItem.findViewById(R.id.text);
			text2.setText("感控群");
			ImageView img2=(ImageView) mSelectCardItem.findViewById(R.id.img);
			img2.setImageResource(R.drawable.team);
			newFriendItem=View.inflate(mcontext, R.layout.new_friend,
					null);
			...
			text.setText("感控圈好友");
			newFriendItem.setOnClickListener(new OnClickListener() {
		...
		// 設置頂部固定頭部
		mListView.addHeaderView(LayoutInflater.from(mcontext)
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == 0xa) {
			...
			// IMAppManager.startChattingAction(ContactsFragment.this.mcontext
	...
	public class ContactsDepartAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			viewHolder.moreLay.setOnClickListener(new OnClickListener() {
