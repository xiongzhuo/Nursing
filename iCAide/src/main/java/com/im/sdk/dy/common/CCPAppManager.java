...
import com.im.sdk.dy.common.utils.MimeTypesTools;
...
import com.im.sdk.dy.ui.chatting.ImageGalleryActivity;
import com.im.sdk.dy.ui.chatting.ImageGralleryPagerActivity;
import com.im.sdk.dy.ui.chatting.ImageMsgInfoEntry;
import com.im.sdk.dy.ui.chatting.ViewImageInfo;
import com.im.sdk.dy.ui.chatting.view.ChatFooterPanel;
...
public class CCPAppManager {
    ...
    /**包名*/
    public static String pkgName = "com.im.sdk.dy";
    /**SharedPreferences 存储名字前缀*/
    public static final String PREFIX = "com.im.sdk.dy_";
    ...
    public static void sendRemoveMemberBR(){
    	...
    	getContext().sendBroadcast(new Intent("com.deya.acaide.Removemember"));
    }
     ...
     * @param username
     */
    public static void startChattingAction(Context context , String contactid , String username,int contactstype) {
        startChattingAction(context , contactid , username , false,contactstype);
    }
     ...
     * @param clearTop
     */
    public static void startChattingAction(Context context , String contactid , String username , boolean clearTop,int contactstype) {
        Intent intent = new Intent(context, ChattingActivity.class);
        if(clearTop) {
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        }
        ...
        intent.putExtra(ChattingFragment.CONTACTS_TYPE, contactstype);
    ...
    * @param clearTop
    */
   public static void startChattingAction(Context context , String contactid , String username ,String avartar, boolean clearTop,int contactstype) {
       Intent intent = new Intent(context, ChattingActivity.class);
       if(clearTop) {
           intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
       }
       ...
       intent.putExtra(ChattingFragment.CONTACT_USER, username);
       intent.putExtra(ChattingFragment.CUSTOMER_SERVICE, false);
       intent.putExtra(ChattingFragment.CONTACT_AVATAR, avartar);
       intent.putExtra(ChattingFragment.CONTACTS_TYPE, contactstype);
