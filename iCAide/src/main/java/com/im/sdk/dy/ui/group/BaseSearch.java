...
/**
 * com.im.sdk.dy.ui.group in ECDemo_Android
...
public class BaseSearch extends ECSuperActivity implements View.OnClickListener{
    ...
    protected int getLayoutId() {
        return R.layout.im_base_search;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, R.drawable.btn_back_style , -1 ,R.string.search_group , this);
