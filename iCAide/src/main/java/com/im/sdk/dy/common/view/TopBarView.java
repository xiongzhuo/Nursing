...
/**
 * IMSDK 顶部导航 Created by yung on 2015/12/17.
 */
public class TopBarView extends LinearLayout {
	...
	private void initView() {
		...
		LayoutInflater.from(getContext()).inflate(
				R.layout.im_common_view_top_bar, this, true);
		...
		mLeftButtonText = (TextView) findViewById(R.id.btn_text_left);
	}
	...
	public void setRightClick(OnClickListener click) {
		mRightText.setOnClickListener(click);
	}
	...
	/**
	 * 设置TopBarView 右侧按钮的隐藏
	 */
	public void setRightVisibleGone() {
		mRightButton.setVisibility(View.GONE);
		mRightText.setVisibility(View.GONE);
		((RelativeLayout) findViewById(R.id.top_progressbar))
				.setVisibility(View.GONE);
	...
	public void setmLeftButtonText(TextView mLeftButtonText) {
	...
	public void setTopBarToStatus(int type, int leftResid, int rightResid,
		...
		if (leftResid <= 0 || leftText != null) {
			...
			mLeftButtonText.setText(R.string.button_back);
			mLeftButtonText.setVisibility(View.VISIBLE);
			mLeftButtonText.setOnClickListener(l);
		}
