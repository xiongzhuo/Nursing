...
import com.im.sdk.dy.common.AnimatorUtils;
import com.im.sdk.dy.common.MethodInvoke;
import com.im.sdk.dy.common.SDKVersionUtils;
import com.im.sdk.dy.common.SwipeActivityManager;
import com.im.sdk.dy.common.utils.LogUtil;
import com.im.sdk.dy.common.utils.SupportSwipeModeUtils;
import com.im.sdk.dy.common.view.SwipeBackLayout;

/**
 * com.im.sdk.dy.ui in ECDemo_Android
 * Created by Jorstin on 2015/6/19.
 */
public class ECFragmentActivity extends BaseFragmentActivity
        implements SwipeActivityManager.SwipeListener , SwipeBackLayout.OnSwipeGestureDelegate{

    private static final String TAG = "IM_PATH.ECFragmentActivity";
    ...
    public boolean onActivityCreate() {
        if(isSupperSwipe()) {
            ...
            mSwipeBackLayout = (SwipeBackLayout) LayoutInflater.from(this).inflate(
                    R.layout.im_swipeback_layout, viewGroup , false);
