...
import com.im.sdk.dy.common.utils.ChattingAysnImageLoader;
...
public class ImageGalleryActivity extends ECSuperActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, R.drawable.btn_back_style, -1, "1 / 1", this);
    ...
    protected int getLayoutId() {
        ...
        return R.layout.im_slide_image;
    }
