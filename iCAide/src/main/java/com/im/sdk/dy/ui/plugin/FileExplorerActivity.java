 ...
 */
package com.im.sdk.dy.ui.plugin;
...
public class FileExplorerActivity extends ECSuperActivity implements
	...
	protected int getLayoutId() {
		return R.layout.im_file_explorer;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(TextUtils.isEmpty(title)) {
			getTopBarView().setTopBarToStatus(1, R.drawable.btn_back_style, -1, R.string.plugin_file_explorer_ui_title, this);
		} else {
			getTopBarView().setTopBarToStatus(1, R.drawable.btn_back_style, -1, title, this);
		}
