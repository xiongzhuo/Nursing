...
public class CCPAlertDialog {
	...
	public Dialog create(){
		...
		final LinearLayout mLlayout = (LinearLayout) this.mInflater.inflate(R.layout.im_dialog_menu_layout, null);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (this.mList != null) {
				...
				if (btnType != TYPE_BUTTON_NORMAL) {
					...
					if (btnType == TYPE_BUTTON_SPECIAL) {
						view = mInflater.inflate(
								R.layout.im_dialog_menu_list_layout_special,
								null);
					} else if (btnType == TYPE_BUTTON_CANCLE) {
						view = mInflater
								.inflate(
										R.layout.im_dialog_menu_list_layout_cancel,
										null);
					} else if (btnType == TYPE_BUTTON_TITLE){
						view = mInflater
						.inflate(
								R.layout.im_dialog_menu_list_layout_title,
								null);
					}
				...
				if (convertView != null && (PopuHolder)convertView.getTag() != null &&((PopuHolder)convertView.getTag()).type == TYPE_BUTTON_NORMAL) {
					...
					view = mInflater
							.inflate(R.layout.im_dialog_menu_list_layout, null);
