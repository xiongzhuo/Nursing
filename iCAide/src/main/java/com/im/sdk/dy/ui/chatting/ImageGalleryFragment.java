...
import com.im.sdk.dy.photoview.PhotoViewAttacher;
...
public class ImageGalleryFragment extends CCPFragment {
    ...
    protected int getLayoutId() {
        return R.layout.im_image_grallery_fragment;
    }
...
//        	mImageView.setImageResource(R.drawable.im_fire_msg_big);
//        	return;
//        }
		...
		if(!ImageGralleryPagerActivity.isInit&&msg!=null&&isFireMsg&&!CCPAppManager.getUserId().equalsIgnoreCase(msg.getForm())){
		   IMessageSqlManager.updateMsgReadStatus(mEntry.getMsgLocalId(), true);
		   ImageGralleryPagerActivity.isInit=true;
