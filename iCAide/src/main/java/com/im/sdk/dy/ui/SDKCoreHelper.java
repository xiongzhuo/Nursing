...
public class SDKCoreHelper implements ECDevice.InitListener , ECDevice.OnECDeviceConnectListener,ECDevice.OnLogoutListener {
    ...
    public static final String ACTION_LOGOUT = "com.im.sdk.dy_logout";
    ...
    /**联系人信息改变*/
    public static final String ACTION_CONTACTS_CHANGE = "com.dy.ACTION_CONTACTS_CHANGE";	
    
    /**手机联系人信息改变*/
    public static final String ACTION_MOBILE_CONTACTS_CHANGE = "com.dy.ACTION_MOBILE_CONTACTS_CHANGE";	
    
    
    public static  String appid = "aaf98f8951a4a43b0151a518cd5e01d7";
    public static  String apptoken = "fa2a20e354587f7632d9e74499a06d20";
...
//        ECDevice.setPendingIntent(pendingIntent);
        ...
        IMChattingHelper.setContext(mContext);
        ...
        mInitParams.reset();
        // 如：VoIP账号/手机号码/..
        if(null!=clientUser&&null!=clientUser.getUserId()){
        mInitParams.setUserid(clientUser.getUserId());
        }else{
        	mInitParams.setUserid("");	
        }
        // appkey
        mInitParams.setAppKey(appid);
        ...
        if(null==clientUser){
            ...
            return ;
        }else  if(!TextUtils.isEmpty(clientUser.getPassword())) {
...
//                ECPreferences.savePreference(ECPreferenceSettings.SETTINGS_FULLY_EXIT, true, true);
            ...
            LogUtil.d("onConnectState", "kill off>>"+error.errorCode+ "  "+error.errorMsg);
            // 失败，账号异地登陆，发送广播到主页面信息处理
    ...
    public void onLogout() {
        ...
        mInitParams = null;
        if(mContext!=null) mContext.sendBroadcast(new Intent(ACTION_LOGOUT));
    }
    ...
    public void onError(Exception exception) {
        ...
        if(null==mContext){
        	mContext=MyAppliaction.getContext();
        }
        mContext.sendBroadcast(intent);
        ECDevice.unInitial();
    }
    ...
    public static void release() {
        ...
        if(null!=ImgInfoSqlManager.getInstance()){
