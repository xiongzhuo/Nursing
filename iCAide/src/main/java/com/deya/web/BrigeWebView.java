...
public class BrigeWebView extends WebView {
    ...
    public BrigeWebView(Context context) {
        super(context);
    }

    public BrigeWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BrigeWebView(Context context, AttributeSet attrs, int defStyleAttr) {
