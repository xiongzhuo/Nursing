...
public abstract class TextViewGroup2 extends RelativeLayout implements
		OnClickListener {
	/**
	 * item 形状
	 *
	...
	public TextViewGroup2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private OnTextViewGroupItemClickListener2 listener;
	...
	public void setOnTextViewGroupItemClickListener(
			OnTextViewGroupItemClickListener2 listener) {
