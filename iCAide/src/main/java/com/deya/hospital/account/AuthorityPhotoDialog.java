 ...
 * @author BMM
 */
public class AuthorityPhotoDialog extends BaseActivity {
    ...
    public void onCancleClick2(View arg0) {
        finish();
    }
    ...
    private void startUploadActivity() {
        ...
        AuthorityPhotoDialog.this.setResult(RESULT_OK, data);
        AuthorityPhotoDialog.this.finish();
    }
