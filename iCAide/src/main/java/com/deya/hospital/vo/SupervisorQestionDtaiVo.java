 ...
 * @date ${date}
 */
public class SupervisorQestionDtaiVo extends BaseTaskVo implements Serializable {
    private static final long serialVersionUID = 00230001101L;
    ...
    String remind_date = "";
    int is_feedback_department;//是否反馈到科室
