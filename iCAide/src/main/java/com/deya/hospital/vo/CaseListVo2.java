 ...
 * @date 2016/10/24
 */
public class CaseListVo2 implements Serializable {
    ...
    public static class CaseListBean implements Serializable {
        ...
        public List<IdAndResultsVo2> resultlist = new ArrayList<>();//最终提交的模板结果集

        public List<IdAndResultsVo2> getResultlist() {
            return resultlist;
        }

        public void setResultlist(List<IdAndResultsVo2> resultlist) {
