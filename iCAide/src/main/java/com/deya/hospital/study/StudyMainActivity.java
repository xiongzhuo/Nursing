 ...
 * @date 2016/11/18
 */
public class StudyMainActivity extends BaseActivity implements RequestInterface {
    private static final int GET_SUB_COUNT =0x811 ;
    GridView gridview;
    StudyMainAdapter adapter;
    List<TaskTypePopVo> list;
    String title[] = {"分类练习", "知识评测", "院内考核", "实战分享", "错题回顾", "我的收藏"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.study_main_fragment);
    ...
    private void initView() {
        ...
        adapter = new StudyMainAdapter(mcontext, list);
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if ( activitys[position]!=null) {
                    Intent intent = new Intent(mcontext, activitys[position]);
        ...
        for (int i = 0; i < title.length; i++) {
            ...
            switch (i){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    vo.setCount(SubjectDbUtils.getlocalDataByKey(mcontext,"isWrong","1").size());
                    break;

                case 5:
                    vo.setCount(SubjectDbUtils.getlocalDataByKey(mcontext,"is_colected","1").size());
                    break;
            }
            list.add(vo);
