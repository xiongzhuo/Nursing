...
public class QuestionDetailImageListAdapter extends BaseAdapter {
	...
	public QuestionDetailImageListAdapter(Context context, List<Attachments> list, ImageAdapterInter adapterInter) {
		this.list = list;
		inflater = LayoutInflater.from(context);
		mcontext = context;
		this.adapterInter=adapterInter;
		int[] wh = AbViewUtil.getDeviceWH(mcontext);
		para = new LayoutParams((wh[0] - dp2Px(mcontext, 70)) / 3,
				(wh[0] - dp2Px(mcontext, 70)) / 3);
