...
public class MyImageListAdapter3 extends BaseAdapter {
//  List<PicListVo> list;
  Context mcontext;
   ...
   */
  public MyImageListAdapter3(Context context,List<Attachments> list) {
    this.list = list;
    ...
    activity=(AnswerQuestionActivity) context;
  }
  public MyImageListAdapter3(Context context, List<Attachments> list, int type) {
	    this.list = list;
	    inflater = LayoutInflater.from(context);
	    mcontext = context;
	    int[] wh = AbViewUtil.getDeviceWH(mcontext);
