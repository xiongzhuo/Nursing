...
import com.deya.hospital.descover.AskQustionActivity;
...
public class MyImageListAdapter2 extends BaseAdapter {
//  List<PicListVo> list;
  Context mcontext;
  ...
  AskQustionActivity activity;
  int type=0;

  /**
   * Creates a new instance of MyImageListAdapter.
   */
  public MyImageListAdapter2(Context context,List<Attachments> list) {
    this.list = list;
    ...
    activity=(AskQustionActivity) context;
  }
  public MyImageListAdapter2(Context context, List<Attachments> list, int type) {
	    this.list = list;
	    inflater = LayoutInflater.from(context);
	    mcontext = context;
	    int[] wh = AbViewUtil.getDeviceWH(mcontext);
