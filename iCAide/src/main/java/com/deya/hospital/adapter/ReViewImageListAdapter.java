...
public class ReViewImageListAdapter extends BaseAdapter {
//  List<PicListVo> list;
  Context mcontext;
   ...
   */
  public ReViewImageListAdapter(Context context,List<Attachments> list) {
    this.list = list;
  ...
  public ReViewImageListAdapter(Context context, List<Attachments> list, int type) {
	    this.list = list;
	    inflater = LayoutInflater.from(context);
	    mcontext = context;
	    int[] wh = AbViewUtil.getDeviceWH(mcontext);
