    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.singleCheckLay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (isyes) {
                    case 0:
                        finalViewHolder.item_check.setVisibility(View.VISIBLE);
                        finalViewHolder.item_check.setImageResource(R.drawable.check_box_right);
                        rItem.setResult("1");
                        if(isSingleCheck){
                        ...
                        break;
                    case 1:
                        finalViewHolder.item_check.setVisibility(View.GONE);
                        rItem.setResult("0");
                        break;
                    default:
                        break;
