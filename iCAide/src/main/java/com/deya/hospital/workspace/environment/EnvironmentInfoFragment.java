 ...
 * @date ${date}
 */
public class EnvironmentInfoFragment extends BasePriviewInfoFragment2 {
    ...
    public static EnvironmentInfoFragment newInstance(CaseListVo2.CaseListBean caseVo) {
        EnvironmentInfoFragment newFragment = new EnvironmentInfoFragment();
