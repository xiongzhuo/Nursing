 ...
 * @date ${date}
 */
public class TabPagerAdapter2 extends BaseAdapter {
    LayoutInflater layoutInflater;
    List<RisistantVo.TempListBean> list;
    int checkPOs;
    onCheckInter inter;
    String text = "临床反馈";
    Context context;
    ...
    public TabPagerAdapter2(Context context, List<RisistantVo.TempListBean> list) {
        ...
        if (position < list.size()) {
            ...
            switch (bean.getTemp_type_id()) {
                ...
                case 5:
                    ...
                    break;
                default:
                    viewHolder.radioButton.setText("现场督察");
                    break;
            }
            ...
            viewHolder.radioButton.setText("备注");
        }
